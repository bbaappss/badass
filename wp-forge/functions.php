...
function wpforge_scripts_styles() {
    ...
    wp_enqueue_script( 'countdown', get_template_directory_uri() . '/js/vendor/jquery.countdown.js', array('jquery'), time(), true );  
    wp_enqueue_script( 'nextPrevWrap', get_template_directory_uri() . '/js/vendor/nextPrevWrap.js', array('jquery'), time(), true );
		wp_enqueue_script( 'foundation-js', get_template_directory_uri() . '/js/foundation/foundation.js', array('jquery'), time(), true );
    wp_enqueue_script( 'foundation-js-abide', get_template_directory_uri() . '/js/foundation/foundation.abide.js', array('jquery'), time(), true );
    wp_enqueue_script( 'foundation-js-alerts', get_template_directory_uri() . '/js/foundation/foundation.alerts.js', array('jquery'), time(), true );
    wp_enqueue_script( 'foundation-js-clearing', get_template_directory_uri() . '/js/foundation/foundation.cookie.js', array('jquery'), time(), true );
    wp_enqueue_script( 'foundation-js-dropdown', get_template_directory_uri() . '/js/foundation/foundation.forms.js', array('jquery'), time(), true );
    wp_enqueue_script( 'foundation-js-interchange', get_template_directory_uri() . '/js/foundation/foundation.interchange.js', array('jquery'), time(), true );
    wp_enqueue_script( 'foundation-js-joyride', get_template_directory_uri() . '/js/foundation/foundation.joyride.js', array('jquery'), time(), true );
    wp_enqueue_script( 'foundation-js-magellan', get_template_directory_uri() . '/js/foundation/foundation.magellan.js', array('jquery'), time(), true );
    wp_enqueue_script( 'foundation-js-placeholder', get_template_directory_uri() . '/js/foundation/foundation.placeholder.js', array('jquery'), time(), true );
    wp_enqueue_script( 'foundation-js-reveal', get_template_directory_uri() . '/js/foundation/foundation.reveal.js', array('jquery'), time(), true );
    wp_enqueue_script( 'foundation-js-section', get_template_directory_uri() . '/js/foundation/foundation.section.js', array('jquery'), time(), true );
    wp_enqueue_script( 'foundation-js-tooltips', get_template_directory_uri() . '/js/foundation/foundation.tooltips.js', array('jquery'), time(), true );
    wp_enqueue_script( 'foundation-js-topbar', get_template_directory_uri() . '/js/foundation/foundation.topbar.js', array('jquery'), time(), true );
    wp_enqueue_script( 'foundation-js-orbit', get_template_directory_uri() . '/js/foundation/foundation.orbit.js', array('jquery'), time(), true );
